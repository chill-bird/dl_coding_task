...
def main():
    ...
    parser.add_argument("model_path", type=str, help="Path to saved model checkpoint (.pt file)")
    ...
    parser.add_argument(
        "--output_dir", type=str, default=None, help="Directory to save predictions and logits"
    )
